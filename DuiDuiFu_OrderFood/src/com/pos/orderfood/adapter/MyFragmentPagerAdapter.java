 ...
 * Time: 下午3:03
 */
public class MyFragmentPagerAdapter extends PagerAdapter implements OnPageChangeListener{
    ...
    public MyFragmentPagerAdapter(FragmentManager fragmentManager, ViewPager viewPager , List<Fragment> fragments) {
