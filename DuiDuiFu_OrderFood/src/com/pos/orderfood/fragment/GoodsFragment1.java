...
import com.pos.orderfood.adapter.GoodAdapter;
import com.pos.orderfood.bean.Good;
import com.pos.orderfood.dialog.PicDialog;
import com.pos.orderfood.dialog.PicDialog.CallBack;
...
public class GoodsFragment1 extends NoBugFragment implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.iv_goodspic:{
			dialog=new PicDialog(contex, new CallBack() {
