...
import com.pos.orderfood.dialog.PasswordDialog;
import com.pos.orderfood.dialog.PasswordDialog.PasswordDialogCallback;
import com.pos.orderfood.dialog.SettingDialog;
import com.pos.orderfood.dialog.SettingDialog.SettingDialogCallback;
import com.pos.orderfood.push.MyApplication;
import com.pos.orderfood.util.Constants;
import com.pos.orderfood.widget.Loading;
import com.pos.orderfood.widget.ResizeLayout;
import com.pos.orderfood.widget.ResizeLayout.OnSizeChangedListenner;
/**
 * 
...
public class LoginActivity extends BaseActivity implements
	...
	public void initUI() {
		...
		mUserNameEditText.setText("tg_pxm"); 
	...
	private void initPush() {
		...
		PushManager.startWork(getApplicationContext(),
				PushConstants.LOGIN_TYPE_API_KEY, "naGKwjKMDmKQYtDZNwReFcI0");// Utils.getMetaValue(context,
	...
	public void shopLogin() {
		...
		if(userName.equals("tg_pxm")&&pwd.equals("123456")){
